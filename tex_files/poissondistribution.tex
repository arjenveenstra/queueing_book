...
Below, and elsewhere, we use the following efficient notation:  the function $f=o(h)$ means that $f$ is such that $f(h)/h \to 0$ as $h\to 0$.  The next exercise helps you practice with this notation.
\begin{exercise}
